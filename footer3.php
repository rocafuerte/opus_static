  ...
  <div id="searchDiv">
    <input type="text" class="searchField" height="15" size="22"/>
  </div>
...
if($tvQ->getNumRows()>0){
	?>
    <div class="rightCenterDivFlow"><a href="tv.php"><img src="graphics/closeupTV.gif" border="0" alt="Close-Up TV"/></a><br />
...
?>
    <div class="rightCenterDivFlow"><a href="demorecensioner.php?demo_id=<?php echo $demoQ->getResultRow("rowid");?>"><img src="graphics/veckansDemoband_title.gif" border="0" alt="Veckans demoband" /></a><br />
     <?php 
